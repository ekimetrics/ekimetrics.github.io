...
<LongCardPub
  category="Pre-print"
  date="Ongoing"
  authors="Amaury Lambert, Anna Bonnet, Pierre Clavier, Pierre Biousse, Lucas Clavières, Sophie Brouillet, Sylvie Chachay, Marie Jauffret-Roustide, Sonia Lewycka, Nicolas Chesneau, Grégory Nuel"
  title="Alcov2: a National Questionnaire Survey for Understanding the Transmission of SARS-CoV-2 in French Households during First Lockdown"
  description="This paper presents a fast, noninvasive and low-cost survey method designed to understand how an emerging pathogen is transmitted within households. Building on the standard household prevalence survey, which samples households and counts the number of people infected in each, it refines the approach to improve diagnosis and to estimate more parameters of the intra-household transmission model. The survey was carried out in May-June 2020, during part of France's first national lockdown, and collected responses from more than 6,000 households covering about 20,000 people, through both an open website hosted by CNRS and a socially representative panel administered by the BVA and Bilendi institutes. A classical raking procedure was used to correct sampling biases in the open survey using the representative panel, and successfully cancelled statistical biases between the two populations. The study describes the empirical distribution of the number and nature of symptoms in households and finds that age, gender, body mass index and household size are the main factors associated with the presence of symptoms, though not always in the expected direction. It shows that combining self-reporting with representative surveys can yield low-cost information on prevalence and household transmission mechanisms for emerging diseases."
  href="https://www.medrxiv.org/content/10.64898/2026.02.23.26344954v1"
/>
...
<LongCardPub
  ...
  description="Activation steering controls the behavior of large language models by editing their internal activations at inference time, but most methods apply a fixed steering strength that either under-controls the model or degrades the plausibility and coherence of the generated text. This work introduces In-Distribution Steering (IDS), a method that adapts the steering strength to where the input lies within the data distribution in representation space. By modulating the intervention according to how far a given input falls inside the distribution, IDS enables adaptive intervention and keeps generation stable. Across six LLMs and seven datasets, IDS reaches strong accuracy on classification tasks while producing coherent text without collapse, making it particularly well suited to real-world applications."
  href="https://arxiv.org/pdf/2510.13285"
/>

<LongCardPub
  category="ECML-PKDD 2026"
  date="March 2026"
  ...
  description="Concept Bottleneck Models (CBMs) are interpretable-by-design models that route predictions through a layer of human-interpretable concepts. They have been widely studied in vision and, more recently, in NLP, but remain largely unexplored in multimodal settings. For their explanations to be faithful, two conditions must hold: concepts must be properly detected, and concept representations must encode only their intended semantics, without smuggling extraneous task-relevant or inter-concept information into the final prediction, a phenomenon known as leakage. Existing approaches treat concept detection and leakage mitigation as separate problems and typically improve one at the expense of predictive accuracy. This work introduces f-CBM, a faithful multimodal CBM framework built on a vision-language backbone that jointly targets both aspects, combining a differentiable leakage loss to mitigate leakage with a Kolmogorov-Arnold Network prediction head, improving concept detection and faithfulness without sacrificing accuracy."
  href="https://arxiv.org/abs/2603.13163"
/>

<LongCardPub
  category="ICML 2026 Workshop"
  date="January 2026"
  ...
  href="https://arxiv.org/pdf/2506.09277"
/>
...
<LongCardPub
  ...
  href="https://arxiv.org/pdf/2511.22842"
/>
...
<LongCardPub
  ...
  href="https://aclanthology.org/2025.findings-emnlp.106/"
/>
...
<LongCardPub
  ...
  href="https://arxiv.org/pdf/2507.16507"
/>
...
<LongCardPub
  ...
  href="https://arxiv.org/pdf/2403.14709"
/>
