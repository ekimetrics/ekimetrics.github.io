...
function Home() {
  ...
  return (
    ...
    <div class="container margin-vert--lg">
      ...
      <section>
          <LongCard category="Data Science Escape Game" date="2020-12" title="Crisis in Korea"  description="A bomb has been planted and risk to explode in the next 3 hours. Use your Data Science skills to track down and defuse the bomb!" href="" src="../../static/img/hacks/cekia.png"/>
          <LongCard category="Case study" date="2020-10" title="The future of French wine in the face of Climate Change"  description="French wine is endangered by the effect of climate change. Browse and cross a dozen of datasets to understand the effects of climate change and imagine actions to sustain the sector in the next 50 years" href="" src="../../static/img/hacks/photo-1560493676-04071c5f467b.jpg"/>
          <LongCard category="Hackathon" date="2019-12" title="Logistics for Christmas"  description="Help Santa Claus plan his delivery tours for Christmas by forecasting demand worlwide and optimizing routing while minimizing carbon footprint" href="" src="../../static/img/hacks/christmas.png"/>
      </section>
    </div>
