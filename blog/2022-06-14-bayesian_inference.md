...
In this article, we will shed a light on one of those tools: **sales prediction.**
...
<div align="center">Fig. 1: Example of magazine sales curves</div>
<br/>
...
There are two big questions: _which factors to take into account and how to encode them?_
...
<div align="center">Fig. 2: Bayesian inference</div>
<br/>
...
p(θ|X<sub>obs</sub>) ∝ p(X<sub>obs</sub>|θ)\*p(θ)
...
p(X<sup>pred</sup><sub>Bayesian</sub>|X<sub>obs</sub>) = ∫p(X<sup>pred</sup><sub>Bayesian</sub>|θ)\*p(θ|X<sub>obs</sub>)dθ
...
<div align="center">Fig. 3: Bayesian sales prediction pipeline</div>
<br/>
...
<div align="center">Fig. 4: Example of the sales predictions of a magazine at day 30</div>
<br/>
