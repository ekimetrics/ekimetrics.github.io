...
header_image_url: "img/blog/whale_docker.jpg"
tags: [Docker, Streamlit]
draft: true
description: "
...
![Docker Containers are just like a layered rainbow cake. Photo by Annie Spratt](img/docker/annie-spratt-unsplash.jpg) 
...
![Docker definitions schema](img/docker/docker-definitions-schema.gif)
...
![Python Docker images size comparison](img/docker/python-docker-images-size-comparison.png)
...
![matplotlib-build-alpine](img/docker/python-matplotlib.png)
...
![docker-cache-example](img/docker/docker-cache-example.gif)
...
![automate-all-the-things](img/docker/automate.png)
