...
Let's explore how we, at Ekimetrics, automate the deployment of our data apps on the cloud. This article will gather elements from our internal & external [workshops](https://www.youtube.com/watch?v=C7v5lY2G4Os) presented at Datacraft and also the video presenting some [docker best practices](https://www.youtube.com/watch?v=lkL3Ve7sDfc&t=97s&ab_channel=datacraft) for industrialization. 
#### TL;DR;
...
### Our app
Let's keep it simple and use venv to create a virtual environment with the following steps :
* ```py -3.8 -m venv .venv```
